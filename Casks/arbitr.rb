cask "arbitr" do
  ...
  url "https://github.com/martinpucik/arbitr/releases/download/v#{version}/Arbitr-#{version}.zip"
  name "Arbitr"
  desc "Send commands to AI harnesses on your Mac from mobile clients"
  homepage "https://github.com/martinpucik/arbitr"

  livecheck do
    url "https://github.com/martinpucik/arbitr/releases/latest"
